...
{
	double _x = (p2.x - p1.x)*(p2.x - p1.x) + (p2.y - p1.y)*(p2.y - p1.y);
	return sqrt(_x);
}
...
{
	char* file1 = "C:/Users/ianzh_000/Documents/GitHub/CS183_Sketch2Web/Source/ShapeContext/A.png";
	char* file2 = "C:/Users/ianzh_000/Documents/GitHub/CS183_Sketch2Web/Source/ShapeContext/A_hand.png";
	if (argc == 3)
	{
	...
	vector <Point> contourPts1 = getContourPtsFromFile(file1);
	vector <Point> contourPts2 = getContourPtsFromFile(file2);
	if (contourPts1.size() == 0 &&contourPts2.size() == 0)
		return -1;
